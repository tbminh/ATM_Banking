                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Quản lý trụ atm</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body p-1">
                            ...
                            <div class="card" >
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{url('/page-admin/truatm/update')}}">
                                        @csrf
                                        <div class="form-group">
                                            <label for=""> Tên trụ atm:</label>
                                            <input type="text" name="atm_name" class="form-control" id="atm_name" placeholder="Nhập tên trụ atm" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="atm_address" class="form-control" id="atm_address" placeholder="Nhập địa chỉ" >
                            ...
                            <script>
                                function initMap() {
                                    ...
                                    autocomplete.addListener("place_changed", (e) => {
                                        ...
                                        document.getElementById('atm_name').value = infowindowContent.children.namedItem("place-name").innerHTML;
                                        document.getElementById('atm_address').value = document.getElementById('pac-input').value;
                            ...
                            <table class="table">
                                ...
                                <tbody id="tbody-table">
                                    @foreach($atms as $key=>$data)
                                        <tr>
                                            <td>{{++$key}}</td>
                                            <td>{{$data->atm_name}}</td>
                                            <td>{{$data->atm_address}}</td>

                                            <td>
                                                <a href="{{url('/page-admin/truatm/delete/'.$data->id)}}"
