<html>
  ...
  <body>
    ...
    <div class="image-page text-center">
        <img src="{{ url('public/upload/banner.webp') }}" class="image-res">
        <div class="title">
            <h1>Địa điểm các phòng giao dịch</h1>
            <p> Phòng giao dịch & trụ ATM</p>
        </div>
    </div>
    ...
    <div id="container">
        <div id="floating-panel">
            <input id="start" type="text" placeholder="Nhập điểm bắt đầu" class="controls" style="font-size: 14px !important;"/>
            <div style="display: flex; width: 550px;">
                <div style="width:100px;font-weight:600;padding: 10px;">Điểm đến:</div>
